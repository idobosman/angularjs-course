...
var contacts = [
	{ id: 1, firstName: 'Frank', lastName: 'Muscles', email: 'frank@muscles.com' },
	{ id: 2, firstName: 'Eddy', lastName: 'Valentino', email: 'eddy@valfam.co.uk' },
	{ id: 3, firstName: 'Piet', lastName: 'Jansen', email: 'piet@jansen.nl' }
];
...
function updateContact(req, res, next) {
	...
	for(var i = 0; i < contacts.length; i++) {
		if(contacts[i].id === parseInt(req.params.contactId)) {
			...
			contacts[i].lastName = req.params.lastName;
